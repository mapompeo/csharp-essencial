...
// Campos estáticos dentro de classes
Carro.ObterValorIPVA();
Console.WriteLine($"Valor do IPVA: {Carro.ValorIpva}%");

// Utilizando struct
Cliente cliente = new Cliente("Roberto", "roberto@email.com", 15);
Cliente.ExibirInfo(nome: "Roberto", email: "roberto@email.com", idade: 20);
Cliente.ExibirInfo(nome: "Roberto", email: "roberto@email.com");
...
public class Carro
{
    ...
    public string Marca;
    // A principal diferença dos campos (código acima) e propriedades (código abaixo) é que utilizamos as propriedades como intermedriários para controlarmos e manipularmos os campos
    private int ano;
    public int Ano
    {
        get { return ano; }
        set { ano = value < 2000 ? 2000 : value > 2022 ? 2022 : value; }
    }
    public int Potencia;
...
public struct Cliente
{
    ...
    public static void ExibirInfo(string nome, string email, int idade = 15)
    {
